  ...
  return (
    <Container>
      ...
      <Alert variant="primary">
        <p>
          🛠️Founded in 2023, AutoAce is a leading servicing website streamlining
          and revolutionising the repairing,maintainence, bike in Nagpur,
          Mumbai, Pune, and Gujrat. Leveraging a Smart AI Pricing Engine, and
          140 quality checks, reparing vehicles is seamless and transparent with
          Autoace.{" "}
        </p>
      </Alert>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12 col-md-10 col-lg-8">
              ...
              <button
                type="button"
                class="btn btn-lg btn-primary mb-3 mb-md-4 mb-xl-5"
              >
                Discover More
              </button>
            </div>
                ...
                <div class="card border-0">
                  ...
                  <div class="card-body border bg-white p-4">
                    ...
                    <p class="card-text entry-summary text-secondary mb-3">
                      A successful vision statement will come from a team
                      effort, everyone working on the service desk and all key
                      stakeholders should be involved and need to agree on the
                      vision bike repair shop watching your machine getting
                      washed or waiting for the repairs to be done.
                    </p>
                  </div>
                </div>
              </article>
              ...
              <article>
                <div class="card border-0">
                  ...
                  <div class="card-body border bg-white p-4">
                    ...
                    <p class="card-text entry-summary text-secondary mb-3">
                      In today’s fast-paced life, taking the time out and riding
                      your bike to the service center could be tiresome. You may
                      not love spending hours in the bike repair shop watching
                      your machine getting washed or waiting for the repairs to
                      be done.
                    </p>
                  </div>
                </div>
              ...
              <div class="row justify-content-xl-center">
                <div class="col-12 col-xl-11">
                  ...
                  <p class="lead fs-4 text-secondary mb-3">
                    We help people to secure time Our perspective is to furnish
            ...
            <div class="col-12 col-lg-6">
              <div class="row justify-content-xl-center">
                <div class="col-12 col-xl-10">
                  ...
                  <button
                    type="button"
                    class="btn bsb-btn-2xl btn-outline-primary rounded-pill"
                  >
                    Connect Now
                  </button>
                </div>
