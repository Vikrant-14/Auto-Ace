    ...
    <>
      ...
      <Card style={{ height: "530px", textAlign: "center" }}>
        ...
        <Card.Body>
          ...
          >
            👉Customers can also bring in their vehicle for servicing at the
            nearest AutoAce car repair workshop. We also provide doorstep car
            services along with doorstep Vehicle repair. We value your time and
            ensure fast delivery of your Vehicle.👈
          </Card.Text>
        </Card.Body>
      </Card>
      <br />
                    ...
                    <div class="card border-0 bg-transparent">
                      <div class="card-body text-center p-5">
                        ...
                        <p class="mb-4 text-secondary">
                          You Can Enroll Service Center On Our Website To Avail
                          Best Services
                        </p>
                        <a
                          href="/AdminPage"
                  ...
                  <div class="col-12 col-md-4 p-0 border-top border-bottom border-start border-end">
                    <div class="card border-0 bg-transparent">
                      <div class="card-body text-center p-5">
                        ...
                        <p class="mb-4 text-secondary">
                          Admin Can View Booking Done By User On Website..
                        </p>
                        <a
                          href="#!"
                          class="fw-bold text-decoration-none link-primary"
                  ...
                  <div class="col-12 col-md-4 p-0">
                    <div class="card border-0 bg-transparent">
                      <div class="card-body text-center p-5">
                        ...
                        <p class="mb-4 text-secondary">
                          Admin Can View Feedback Regarding Service Center..
                        </p>
                        <a
                          href="#!"
                          class="fw-bold text-decoration-none link-primary"
