  ...
  const handleSubmit = (event) => {
    ...
    axios
      ...
      .then((response) => {
        ...
        console.log(response.data.customerId); //custoemrId = adminID {backaend madhe naming chukley}
        sessionStorage.setItem("adminId", response.data.customerId);
        localStorage.setItem("adminId", response.data.customerId);
            ...
            <CardBody>
              ...
              <Form onSubmit={handleSubmit} className="mb-3">
                ...
                <Container className="mb-2">
                  ...
                  <a href="/AdminRegistration" className="ml-5 px-5">
                    Register Now..
                  </a>
                </Container>
              </Form>
