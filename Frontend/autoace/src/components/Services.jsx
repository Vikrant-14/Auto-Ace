      ...
      <div class="col-12 col-lg-5">
        <div class="row">
          <div class="col-12 col-xl-11">
            ...
            <p class="mb-3 mb-xl-4">A regular checkup is critical to ensure your bike is safe to ride, to prevent wear and tear of expensive components and to also ensure your bike is performing at its highest level to ensure our riders ride longer and more often.
</p>
            <a href="/" class="btn bsb-btn-3xl btn-primary rounded-pill">More Details</a>
          </div>
        </div>
      </div>
          ...
          <div class="col-12 col-sm-6">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <h4 class="mb-4">Online Appointment</h4>
                <p class="mb-4 text-secondary">User Can Book The Slot Benefical For Him And Can Acquire Best Service From Us.We Are Ready To Help You</p>
          ...
          <div class="col-12 col-sm-6">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <p class="mb-4 text-secondary">User Can Give Feedback Regarding Whether He like Our Services Or Not Or He/She Want More Improvement From Us</p>
                <a href="#!" class="fw-bold text-decoration-none link-primary">
                  Learn More
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
          ...
          <div class="col-12 col-sm-6">
            <div class="card border-0 border-bottom border-primary shadow-sm">
              <div class="card-body text-center p-4 p-xxl-5">
                ...
                <h4 class="mb-4">Regsitration Avaiable</h4>
                <p class="mb-4 text-secondary">Service Center Owner Can Register On Our Website To Avail Service .He Can Genrate Online Invoice And Send it to User</p>
                <a href="#!" class="fw-bold text-decoration-none link-primary">
                  Learn More
                  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-arrow-right-short" viewBox="0 0 16 16">
                    <path fill-rule="evenodd" d="M4 8a.5.5 0 0 1 .5-.5h5.793L8.146 5.354a.5.5 0 1 1 .708-.708l3 3a.5.5 0 0 1 0 .708l-3 3a.5.5 0 0 1-.708-.708L10.293 8.5H4.5A.5.5 0 0 1 4 8z" />
