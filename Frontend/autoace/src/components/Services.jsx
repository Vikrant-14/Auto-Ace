            ...
            <div class="col-12 col-lg-5">
              <div class="row">
                <div class="col-12 col-xl-11">
                  <h3 class="fs-6 text-secondary mb-3 mb-xl-4 text-uppercase">
                    What We Do?
                  </h3>
                  ...
                  <p class="mb-3 mb-xl-4">
                    A regular checkup is critical to ensure your bike is safe to
                    ride, to prevent wear and tear of expensive components and
                    to also ensure your bike is performing at its highest level
                    to ensure our riders ride longer and more often.
                  </p>
                  <a href="#!" class="btn bsb-btn-3xl btn-primary rounded-pill">
                    More Details
                  </a>
                </div>
              </div>
                  ...
                  <div class="card border-0 border-bottom border-primary shadow-sm">
                    <div class="card-body text-center p-4 p-xxl-5">
                      ...
                      <p class="mb-4 text-secondary">
                        User Can Book The Slot Benefical For Him And Can Acquire
                        Best Service From Us.We Are Ready To Help You
                      </p>
                      <a
                        href="#!"
                ...
                <div class="col-12 col-sm-6">
                  <div class="card border-0 border-bottom border-primary shadow-sm">
                    <div class="card-body text-center p-4 p-xxl-5">
                      ...
                      <p class="mb-4 text-secondary">
                        User Can Give Feedback Regarding Whether He like Our
                        Services Or Not Or He/She Want More Improvement From Us
                      </p>
                      <a
                        href="#!"
                        class="fw-bold text-decoration-none link-primary"
                ...
                <div class="col-12 col-sm-6">
                  <div class="card border-0 border-bottom border-primary shadow-sm">
                    <div class="card-body text-center p-4 p-xxl-5">
                      ...
                      <p class="mb-4 text-secondary">
                        Service Center Owner Can Register On Our Website To
                        Avail Service .He Can Genrate Online Invoice And Send it
                        to User
                      </p>
                      <a
                        href="#!"
