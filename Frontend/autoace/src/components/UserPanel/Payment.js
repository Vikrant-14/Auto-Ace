import ServiceNavigationbar from "../ServiceCenterPanel/ServiceNavigationBar";
            ...
            <div class="row">
              <div class="col-12">
                <div class="mb-5">
                  ...
                  <img src={Razorpay} alt="heropageImg" style={{height:'88px'}} className="ml-25 mx-auto d-block"/> 
